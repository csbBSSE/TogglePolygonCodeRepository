...
path = 'path_to_the_RACIPE_simulations/FIVE/3'; % path of the file for network in question
components_num = 5; % number of components in network
external_signal = 0;
sol_num = 2; 
...
for ii = 1:size(parameter_sets_for_simulating,1)
   ...
   parfor jj = 1:num_initials
       ...
       I = [Ajj Bjj Cjj Djj Ejj];

       [t,y] = ode45(@(t,y)dynamic_simulation_FIVE(t,y,parameter_sets_for_simulating(ii,:)),run_time,I) ;
